...
T = TypeVar("T", bound="ApiEndpointsQueryBodyRange")


@_attrs_define
class ApiEndpointsQueryBodyRange:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_endpoints_query_body_range = cls(
            from_=from_,
            to=to,
            raw=raw,
        )

        api_endpoints_query_body_range.additional_properties = d
        return api_endpoints_query_body_range
